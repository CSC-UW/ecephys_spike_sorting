...
# as implemented, "within_unit_overlap window" must be >= "between unit overlap window"
        ...
        "noise_waveform_params" : {
            ...
            "mid_spread_threshold": mid_spread_threshold,
            "max_spread_threshold": max_spread_threshold,
            "min_wavelet_peak_height": min_wavelet_peak_height,
            "min_wavelet_peak_loc": min_wavelet_peak_loc,
            "max_wavelet_peak_loc": max_wavelet_peak_loc,
            "min_temporal_peak_location": min_temporal_peak_location,
            "max_temporal_peak_location": max_temporal_peak_location,
            "peak_locs_std_thresh": peak_locs_std_thresh,
        },
